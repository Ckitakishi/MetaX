...
class SettingsTableViewCell: UITableViewCell {
    ...
    private func setupUI() {
        ...
        [iconBgView, titleLabel, valueLabel, chevronImageView].forEach {
        ...
        valueTrailingConstraint = valueLabel.trailingAnchor.constraint(equalTo: targetView.trailingAnchor, constant: -padding - 1)
        valueChevronConstraint = valueLabel.trailingAnchor.constraint(equalTo: chevronImageView.leadingAnchor, constant: -8)
